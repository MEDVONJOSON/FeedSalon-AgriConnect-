...
Uses synchronous connections for migrations.
"""

import sys
from pathlib import Path

# Add src directory to Python path so we can import app modules
...
# Set the database URL from our settings (sync URL for migrations)
