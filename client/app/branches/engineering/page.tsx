          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl shadow-sm p-6 mb-8">
              ...
              <div className="flex gap-4">
                <button className="flex-1 bg-slate-800 text-white py-2 rounded-lg hover:bg-slate-900 transition-colors">
                  Add Main Line
                </button>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              <h2 className="text-xl font-semibold mb-4">Machinery Maintenance Log</h2>
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="flex items-center justify-between p-4 border rounded-lg">
                    <div>
                      <div className="font-medium text-gray-900">{log.machine}</div>
                      <div className="text-sm text-gray-500">{log.task}</div>
                    </div>
                    <div className="text-right">
                      <div className={`text-sm font-medium ${
                        log.status === 'Urgent' ? 'text-red-600' : 'text-gray-700'
                      }`}>{log.due}</div>
                      <div className="text-xs text-gray-400">{log.status}</div>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 bg-blue-50 rounded-lg mt-4">
                  <div className="text-sm text-blue-800 mb-1">Daily Water Need:</div>
                  <div className="text-2xl font-bold text-blue-900">4,500 Liters</div>
                </div>
              </div>
            </div>
          </div>
